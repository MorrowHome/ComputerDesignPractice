...
<center><img src = "../assets/trace/remote-1.png" width = 400></center>
...
![安装插件](../assets/trace/vscode_extension.png)

&emsp;&emsp;左侧边栏将出现此图标：<img src = "../assets/trace/icon.png" width = 30>。点击这个图标，选择`SSH TARGETS`右侧的`+`号，如下图所示。

<center><img src = "../assets/trace/ssh_add_host.png" width = 400></center>
...
![连接5](../assets/trace/connect5.png)

&emsp;&emsp;在弹出的菜单中，选择cdp-tests，并按下“确认”：

![连接6](../assets/trace/connect6.png)

&emsp;&emsp;再次输入密码，按下回车确认，并信任作者。

![连接7](../assets/trace/connect7.png)
...
<center><img src = "../assets/trace/mobaxterm-1.png" width = 600></center>

&emsp;&emsp;在弹出的对话框中，选择SSH。

![mobaxterm2](../assets/trace/mobaxterm-2.png)

&emsp;&emsp;SSH配置信息如下：

![mobaxterm3](../assets/trace/mobaxterm-3.png)

&emsp;&emsp;输入密码：

![mobaxterm4](../assets/trace/mobaxterm-4.png)

&emsp;&emsp;进入终端。

![mobaxterm5](../assets/trace/mobaxterm-5.png)

#### 2.2.2 FTP文件传输

&emsp;&emsp;SSH远程登录完毕，双击左下角的`Sftp`，就出现了远程服务器的文件目录。

![mobaxterm6](../assets/trace/mobaxterm-6.png)
...
![keygen](../assets/trace/ssh_keygen.png)
...
<center><img src = "../assets/trace/char.png" width = 600></center>

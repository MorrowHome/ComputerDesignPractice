...
<center><img src = "../assets/verify/v-1(1).jpg" width = 400></center>
<center>抓取写回信息</center>

<center><img src = "../assets/verify/v-1(2).jpg" width = 400></center>
<center>抓取PC寄存器</center>

<center><img src = "../assets/verify/v-1(3).jpg" width = 400></center>
...
<center><img src = "../assets/verify/v-2.jpg" width = 280></center>

&emsp;&emsp;随后会出现如下界面，点击Next：

<center><img src = "../assets/verify/v-3.jpg" width = 600></center>

&emsp;&emsp;随后会列出抓取的Debug信息，点击Next：

<center><img src = "../assets/verify/v-4.jpg" width = 600></center>

&emsp;&emsp;选择抓取的深度和触发控制类型，点击Next（更高级的调试可以勾选“Advanced trigger”）：

<center><img src = "../assets/verify/v-5.jpg" width = 600></center>

&emsp;&emsp;最后，点击Finish：

<center><img src = "../assets/verify/v-6.jpg" width = 600></center>

### 2.3 实现并生产bit流文件

&emsp;&emsp;在2.2节完成后会出现类似下图界面，直接点击Generate Bitstream：

<center><img src = "../assets/verify/v-7.jpg"></center>

&emsp;&emsp;弹出如下界面，点击Save：

<center><img src = "../assets/verify/v-8.jpg" width = 400></center>
...
<center><img src = "../assets/verify/v-9.jpg"></center>
...
<center><img src = "../assets/verify/v-16.jpg" width = 600></center>
...
<center><img src = "../assets/verify/v-17.jpg"></center>
...
<center><img src = "../assets/verify/v-18.jpg"></center>

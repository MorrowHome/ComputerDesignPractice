...
MEMORY
{
    rom  : ORIGIN = 0x00000000, LENGTH = 50K   /* BMEM: .text */
    ram1 : ORIGIN = 0x0000C800, LENGTH = 50K   /* BMEM: .data, .rodata, etc. */
    ram2 : ORIGIN = 0x20000000, LENGTH = 512M   /* DDR3: HEAP and STACK */
}
